...
def test_state_direct_sign_to_allcomfirm():
    ...
    ballot_init_3 = Ballot(ballot_id, node_name_3, message, IsaacState.INIT, BallotVotingResult.agree, ballot_init_2.timestamp)
    ballot_init_4 = Ballot(ballot_id, node_name_4, message, IsaacState.INIT, BallotVotingResult.agree, ballot_init_2.timestamp)
    ...
    ballot_sign_2 = Ballot(ballot_id, node_name_2, message, IsaacState.ACCEPT, BallotVotingResult.agree, ballot_init_2.timestamp)
    ballot_sign_3 = Ballot(ballot_id, node_name_3, message, IsaacState.ALLCONFIRM, BallotVotingResult.agree, ballot_init_2.timestamp)
    ballot_sign_4 = Ballot(ballot_id, node_name_4, message, IsaacState.ALLCONFIRM, BallotVotingResult.agree, ballot_init_2.timestamp)
    ...
    ballot_id = ballot_init_2.ballot_id
    ballot_init_3 = Ballot(ballot_id, node_name_3, message2, IsaacState.INIT, BallotVotingResult.agree, ballot_init_2.timestamp)
    ballot_init_4 = Ballot(ballot_id, node_name_4, message2, IsaacState.INIT, BallotVotingResult.agree, ballot_init_2.timestamp)
    ...
    ballot_sign_2 = Ballot(ballot_id, node_name_2, message2, IsaacState.SIGN, BallotVotingResult.agree, ballot_init_2.timestamp)
    ballot_sign_3 = Ballot(ballot_id, node_name_3, message2, IsaacState.SIGN, BallotVotingResult.agree, ballot_init_2.timestamp)
    ballot_accept_4 = Ballot(ballot_id, node_name_4, message2, IsaacState.ACCEPT, BallotVotingResult.agree, ballot_init_2.timestamp)
    ...
    ballot_accept_2 = Ballot(ballot_id, node_name_2, message2, IsaacState.ACCEPT, BallotVotingResult.agree, ballot_init_2.timestamp)
